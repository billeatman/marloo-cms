...
<cffunction name="runCode" returntype="string" output="false">
	<cfargument name="width" required="false" default="400">
	<cfargument name="height" required="false" default="300">
	<cfargument name="s_content" required="false" default="">

<!---	<cfset super.runCode(argumentCollection=arguments)> --->
	...
	<cfset addHTMLHead(getJQFancyTransitions(argumentCollection: arguments, id: local.id))>
...
<!---
       	<cfinvoke component="#baseCFCPath#.core.imageCore" method="imageCacher" returnvariable="local.webPath">
          	<cfinvokeargument name="imagePath" value="#myImages[1].filepath#">
            <cfinvokeargument name="imageChain" value='[{"FUNC":"imageCropHead"},{"FUNC":"imageResize","WIDTH":65.0,"HEIGHT":65.0}]'>
	        <cfinvokeargument name="config" value="#variables#">
        </cfinvoke> 
--->
		        ...
		        <cfif findnocase(sc.CMS.web.groups, local.i.xmlAttributes.src) neq 0>
		            ...
		            <cfset local.src = sc.CMS.web.groups & local.src>
			      	...
			      	<cfinvoke component="#baseCFCPath#.core.imageCore" method="imageCacher" returnvariable="local.webPath">
			            ...
			            <cfinvokeargument name="imageChain" value='[{"FUNC":"imageScaleToFit","WIDTH":#arguments.width#,"HEIGHT":#arguments.height#}]'>
				        <cfinvokeargument name="site_config" value="#sc#">
			        </cfinvoke>
		        	</cfsilent>
			        <img src='#local.webPath#'>
		        </cfif>
 			</cfloop>
 		</div>
    </cfsavecontent>
...
<cffunction name="getJQFancyTransitions" returntype="string" access="private" output="false">
<cfsavecontent variable="local.js">
<cfoutput>
<script>
$(document).ready( function(){
	$('###arguments.id#').jqFancyTransitions({ width: #arguments.width#, height: #arguments.height# });
});
</script>
</cfoutput>
</cfsavecontent>
