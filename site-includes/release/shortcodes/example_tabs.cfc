...
<!---
THE TABS SHORTCODE - WE / CM
creates tabs that will change size and switch modes responsively, so they become mobile-friendly
TWO MODES: mini (accordion-style) and max (classic tabs)

OTHER CODE WRITTEN FOR THIS SHORTCODE
• tab.cfc
- sets the info for each individual tab
...
// tab contents here
// this one will be open if it's selected
[/tab]
[/tabs]

BEFORE SCRIPT (what's inserted by CF):
<ANY-ELEMENT class="r-tabs">
	<div class="r-tab">
		<div class="r-title">TITLE HERE</div>
		// tab contents here
	</div>
</ANY-ELEMENT>

AFTER SCRIPT (jQuery magic):
<ANY-ELEMENT class="r-tabs [mini/max]" id="tabs1">
	<div class="r-nav"> // visible only on max, for horizontal link list
		<a class="r-title [open]" href="URL##tabs1-[tabTitle]" name="tabs1-tabTitle">TITLE</a>
	</div>
	<hr /> // aesthetic
	<div class="r-tab [open]">
		<a class="r-title" href="URL##tabs1-[tabTitle]" name="tabs1-tabTitle">TITLE</a> // visible only on mini
		<div class="r-content">
		// tab contents here
		</div>
	</div>
...
Reproduced into Limber Responsive Tabs:
