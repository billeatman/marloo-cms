component displayName="testcore" extends="testbox.system.BaseSpec" {
...
*/ 
public void function resetDatabase(required string datasource) {
	resetDB = new Query(datasource=arguments.datasource);
	resetDB.setSql("
-- Populate Leo CMS
...
INSERT INTO [mrl_template]
     ...
     VALUES
           ('leotest','default test template','leotest','john smith','F','500','500')
